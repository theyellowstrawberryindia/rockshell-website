...
<section class="high-temp-pump">
  ...
  <p class="breadcrumb-text current">
    <a href="low-gwp-refrigenant">Low-GWP Refrigerant Heat Pumps</a>
  </p>
</div>

    <div class="high-temp-content">
      <div class="high-temp-text">
        <h3>Low-GWP Refrigerant Heat Pumps</h3>
        <p>
         Future-proof heating and cooling with climate-conscious refrigerants.  
      Our Low Global Warming Potential (Low-GWP) Heat Pumps are designed to deliver high-efficiency heating and cooling while minimizing environmental impact.  
      Using next-generation refrigerants with GWP values far below traditional HFCs, these systems help businesses meet evolving climate regulations, improve sustainability performance, and ensure long-term system viability.
        </p>
...
<section class="why-choose-us">
  ...
  <h3>Ideal For:</h3>
  <ul class="reasons">
    <li>Commercial buildings and green retrofits</li>
    <li>Industrial process heating &amp; cooling</li>
    <li>Food and beverage processing</li>
    <li>Pharmaceutical manufacturing</li>
    <li>District and campus heating networks</li>
  </ul></div>
</section>
  ...
  <div class="container">
    ...
    <div class="faq-item">
      <div class="faq-question">
        <h4>What does Low-GWP mean?</h4>
        <img src="assets/Dropdown.svg" alt="Toggle answer" class="dropdown-icon" />
      </div>
      <div class="faq-answer">
        <p>
          Low-GWP (Global Warming Potential) refers to refrigerants that have a much smaller impact on climate change compared to traditional refrigerants like R-410A or R-407C. These typically have GWP values under 10.
        </p>
      </div>
      <hr />
    </div>
    ...
    <div class="faq-item">
      <div class="faq-question">
        <h4>Why should I switch to a Low-GWP heat pump?</h4>
        <img src="assets/Dropdown.svg" alt="Toggle answer" class="dropdown-icon" />
      </div>
      <div class="faq-answer">
        <p>
          Switching helps reduce your carbon footprint, ensures compliance with upcoming refrigerant phase-downs (such as the EU F-Gas Regulation), and protects your investment from future bans.
        </p>
      </div>
      <hr />
    </div>
    ...
    <div class="faq-item">
      <div class="faq-question">
        <h4>Are Low-GWP refrigerants as efficient as traditional ones?</h4>
        <img src="assets/Dropdown.svg" alt="Toggle answer" class="dropdown-icon" />
      </div>
      <div class="faq-answer">
        <p>
          Yes. Modern Low-GWP refrigerants like R-1234ze and ammonia (R-717) can match or exceed the efficiency of older refrigerants while being far better for the environment.
        </p>
      </div>
      <hr />
    </div>
    ...
    <div class="faq-item">
      <div class="faq-question">
        <h4>Can Low-GWP heat pumps produce high-temperature hot water?</h4>
        <img src="assets/Dropdown.svg" alt="Toggle answer" class="dropdown-icon" />
      </div>
      <div class="faq-answer">
        <p>
          Absolutely. Certain Low-GWP systems can deliver hot water up to 130°C, making them ideal for industrial process heating and district heating.
        </p>
      </div>
      <hr />
    </div>
    ...
    <div class="faq-item">
      <div class="faq-question">
        <h4>What industries benefit most from Low-GWP heat pumps?</h4>
        <img src="assets/Dropdown.svg" alt="Toggle answer" class="dropdown-icon" />
      </div>
      <div class="faq-answer">
        <p>
          They are widely used in commercial buildings, food and beverage processing, pharmaceuticals, manufacturing, and district heating networks where sustainability and regulation compliance are priorities.
        </p>
      </div>
      <hr />
    </div>
